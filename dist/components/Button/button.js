...
export var Button = function (props) {
    var _a;
    var disabled = props.disabled, className = props.className, size = props.size, btnType = props.btnType, href = props.href, children = props.children, restProps = __rest(props, ["disabled", "className", "size", "btnType", "href", "children"]);
